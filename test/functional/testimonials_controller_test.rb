...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { testimonial_text: @testimonial.testimonial_text, written_by: @testimonial.written_by }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { testimonial_text: @testimonial.testimonial_text, written_by: @testimonial.written_by }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
